...
<body>
	...
	<div class="container pt-5 pb-5 mb-5 border-bottom">
		<div class="row justify-content-center">
			<!-- section 있던 자리 -->
			<form method="post" name='petspecies' action="updateP.do">
			<input type="hidden" name="pid" value="${pet.pid}">
				...
				<div class="form-group">
					<label class="text-black" for="pname">반려동물의 이름을 알려주세요!</label> <input
						...
						placeholder="예) 까미, 쿠키, 바둑이" value="${pet.pname}" >
				</div>
				<div class="form-group">
				...
				<div class="row">
					<div class="col-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="pbirth" name="pbirth" value="${pet.pbirth}" >
						</div>
					</div>
					<div class="col-6">
						<div class="form-group">
							<label class="text-black" for="page">나이를 선택해주세요!</label> 
				...
				<div class="form-group">
					<div data-v-9102220a="" class="my-pet-contents-input-wrapper">
						...
						<select data-v-9102220a="" name="pweight"class="form-control">
				...
				<div class="form-group">
					<button type="submit" class="btn btn-outline-black btn-block">펫 정보변경하기</button>
					<button type="button" class="btn btn-outline-black btn-block"
						id="deleteP" data-toggle="modal" data-target="#myModal">펫 삭제하기</button>
				</div>
			</form>
			<!-- Modal -->
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							<div class="modal-header">
								<h4 class="modal-title">펫 삭제</h4>
								<button type="button" class="close" data-dismiss="modal">x</button>
							</div>
							<div class="modal-body">
								<p style="text-align:center; font-size:20px;">정말로 펫을 삭제하시겠습니까?</p>
							</div>
								...
								<table>
									<tr>
										...
										<td style="text-align: right; padding-right: 10px;">
											<a href="deleteP.do?pid='${pet.pid}'"><button type="button" class="btn btn-default"
												>예</button></a>
										</td>
									</tr>
								</table>
