					...
					<div class="col-lg-7" data-aos="fade-up" data-aos-delay="200">
						...
						<form method="post" action="signup.jsp">
							<div class="form-group">
								<label class="control control--checkbox" for="agree1"> <span
									class="caption">다음 이용 약관에 동의합니다.</span> <input type="checkbox"
									class="form-control" id="agree1" required="required"
									title="약관에 동의해야합니다.">
									<div class=control__indicator></div>
								</label>
								<p class="agree">제1조 (목적)
본 약관은 펫키지 주식회사(이하 '회사')가 펫키지 사이트(이하 ‘사이트’)를 통하여 인터넷상에서 제공하는 서비스(이하 ‘서비스’)를 이용하는 고객 (이하 '고객')간의 권리와 의무 및 책임 등 기타 제반사항을 규정함을 목적으로 합니다.
...
3. 회원은 반드시 회원 본인의 정보를 제공하여야만 서비스를 이용할 수 있으며, 타인의 정보를 도용하거나 허위의 정보를 등록하는 등 본인의 정확한 정보를 등록하지 않은 회원은 서비스 이용과 관련하여 아무런 권리를 주장할 수 없으며, 관계 법령에 따라 처벌 받을 수 있습니다. 또한 제 3자에게 야기한 손해를 배상할 책임이 있으며, 회사는 허위의 정보를 기재한 회원의 서비스 이용 자격을 제한할 수 있습니다.
							...
							<div class="form-group">
								<label class="control control--checkbox" for="agree2"> <span
									class="caption">다음 이용 약관에 동의합니다.</span> <input type="checkbox"
									class="form-control" id="agree2" required="required"
									title="약관에 동의해야합니다.">
									<div class=control__indicator></div>
								</label>
								<p class="agree">제6조 (개인정보의 보호 및 사용)
...
6. 회사는 회원의 상기 제1항, 제 2항, 제 3항, 제 4항, 제 5항을 위반하여 회원에게 발생한 손해에 대하여 어떠한 책임도 부담하지 않습니다.
							...
							<div class="form-group">
								<label class="control control--checkbox" for="agree3"> <span
									class="caption">다음 이용 약관에 동의합니다.</span> <input type="checkbox"
									class="form-control" id="agree3" required="required"
									title="약관에 동의해야합니다.">
									<div class=control__indicator></div>
								</label>
								<p class="agree">제11조 (회원 탈퇴 및 자격 상실)
